...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signup() async {
    ...
    final res = await db.insertUser({'username': username, 'password': password});
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.person_add_alt_1, size: 60, color: Colors.white),
                    ),
                    const SizedBox(height: 16),
                    const Text("Create Account", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.brown)),
                    const SizedBox(height: 8),
                    Text("Sign up to continue", style: TextStyle(color: Colors.white70, fontSize: 15)),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(borderSide: const BorderSide(color: Colors.brown, width: 1.5), borderRadius: BorderRadius.circular(16)),
                        focusedBorder: OutlineInputBorder(borderSide: const BorderSide(color: Colors.brown, width: 2), borderRadius: BorderRadius.circular(16)),
                      ),
